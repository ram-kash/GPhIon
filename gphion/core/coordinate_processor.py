...
class CoordinateProcessor:
    ...
    def frac_and_disp(self, sim_data):
        ...
        print(f'DEBUG: Calculating fractional coordinates and displacement for {sim_data.nr_atoms} diffusing atoms...')
        ...
        lattice_inv = np.linalg.inv(sim_data.lattice.T)
        ...
        for atom in range(sim_data.nr_atoms):
            ...
            for time in range(sim_data.nr_steps):
                ...
                unfolded_cart_pos = sim_data.cart_pos[:, atom, time] + np.dot(sim_data.lattice.T, uc)
